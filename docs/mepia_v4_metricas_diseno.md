...
6. **Diseñar Nivel 3**: probar el pipeline completo hasta N05→N14, para validar la consolidación de hallazgos que Nivel 2 no puede probar (S4 tiene prohibido consolidar por diseño). Es el siguiente hueco real de validación.
