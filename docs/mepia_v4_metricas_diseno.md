...
6. **Nivel 3a, 3b, y N05→N06→Layer3 completo, todos cerrados.** Nivel 3a (`tests/eval_test/eval_runner_n05.py`): 8/8 en decisión de escalar. Nivel 3b (`tests/eval_test/eval_runner_n3b.py`): 8/8 aprobados limpio. N05→N06 (decisión #18) y N06→Layer3 (decisión #19): ambos conectados de verdad, ya no son stubs ni requieren disparo manual. No queda ningún hueco de integración conocido en el pipeline principal, de S1B hasta N14.
